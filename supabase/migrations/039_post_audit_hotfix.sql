...
DROP POLICY IF EXISTS "transaction_items_select_scoped" ON public.transaction_items;
...
DROP POLICY IF EXISTS "transaction_items_insert_scoped" ON public.transaction_items;
...
DROP POLICY IF EXISTS "stock_alerts_select_scoped" ON public.stock_alerts;
...
DROP POLICY IF EXISTS "daily_sales_select_scoped" ON public.daily_sales;
...
DROP POLICY IF EXISTS "daily_stock_select_scoped" ON public.daily_stock;
...
DROP POLICY IF EXISTS "cash_sessions_select_scoped" ON public.cash_sessions;
...
DROP POLICY IF EXISTS "operational_expenses_select_scoped" ON public.operational_expenses;
...
DROP POLICY IF EXISTS "operational_expenses_insert_scoped" ON public.operational_expenses;
...
DROP POLICY IF EXISTS "transaction_approvals_select_scoped" ON public.transaction_approvals;
...
DROP POLICY IF EXISTS "transaction_approvals_insert_scoped" ON public.transaction_approvals;
...
DROP POLICY IF EXISTS "transaction_approvals_update_scoped" ON public.transaction_approvals;
...
DROP POLICY IF EXISTS "pos_devices_select_scoped" ON public.pos_devices;
...
DROP POLICY IF EXISTS "promotions_select_scoped" ON public.promotions;
...
DROP POLICY IF EXISTS "billing_history_select_scoped" ON public.billing_history;
...
DROP POLICY IF EXISTS "business_profiles_select_scoped" ON public.business_profiles;
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_shifts_one_active_per_cashier_outlet
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_outlets_tenant_name ON public.outlets(tenant_id, name);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_promotions_tenant_code ON public.promotions(tenant_id, code);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_transactions_tenant_txn_id ON public.transactions(tenant_id, transaction_id);
